...
# Compilar la imagen del Backend (v6)
docker build -t delieats-back:v6 -f ./orders-service/Dockerfile ./orders-service

# Compilar la imagen del Frontend (v14 - Versión Estable)
docker build -t delieats-front:v14 -f ./front/Dockerfile ./front
```
